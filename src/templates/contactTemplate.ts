...
export const contactTemplate = ({ name, email, mobile, message }: FormData) => {
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #FFFFFF; border-radius: 8px; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.1);">
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <h1 style="color: #C370BF">A new inquery has arrived!</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 1.2rem;"><strong style="display: inline-block;">Contact:</strong><span style="padding-left: 8px;">${mobile}</span></p>
